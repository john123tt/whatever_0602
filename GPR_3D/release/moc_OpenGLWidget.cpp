...
struct qt_meta_stringdata_CLASSOpenGLWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSOpenGLWidgetENDCLASS = QtMocHelpers::stringData(
    "OpenGLWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSOpenGLWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject OpenGLWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSOpenGLWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSOpenGLWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSOpenGLWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *OpenGLWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSOpenGLWidgetENDCLASS.stringdata0))
