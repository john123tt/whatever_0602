...
template <> constexpr inline auto QCPLayoutElement::qt_create_metaobjectdata<qt_meta_tag_ZN16QCPLayoutElementE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<enum SizeConstraintRect>(10, 0x80000000 | 11, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet),
    };
    QtMocHelpers::UintData qt_enums {
        // enum 'UpdatePhase'
        QtMocHelpers::EnumData<enum UpdatePhase>(12, 12, QMC::EnumFlags{}).add({
            {   13, UpdatePhase::upPreparation },
            {   14, UpdatePhase::upMargins },
            {   15, UpdatePhase::upLayout },
        }),
        // enum 'SizeConstraintRect'
        QtMocHelpers::EnumData<enum SizeConstraintRect>(11, 11, QMC::EnumFlags{}).add({
...
template <> constexpr inline auto QCPAxis::qt_create_metaobjectdata<qt_meta_tag_ZN7QCPAxisE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<enum LabelSide>(35, 0x80000000 | 36, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet),
    ...
    QtMocHelpers::UintData qt_enums {
        ...
        // enum 'LabelSide'
        QtMocHelpers::EnumData<enum LabelSide>(36, 36, QMC::EnumFlags{}).add({
        ...
        // enum 'SelectablePart'
        QtMocHelpers::EnumData<enum SelectablePart>(78, 78, QMC::EnumFlags{}).add({
...
template <> constexpr inline auto QCustomPlot::qt_create_metaobjectdata<qt_meta_tag_ZN11QCustomPlotE_t>()
{
    ...
    QtMocHelpers::UintData qt_enums {
        ...
        QtMocHelpers::EnumData<enum LayerInsertMode>(57, 57, QMC::EnumFlags{}).add({
            {   58, LayerInsertMode::limBelow },
            {   59, LayerInsertMode::limAbove },
        }),
        // enum 'RefreshPriority'
        QtMocHelpers::EnumData<enum RefreshPriority>(60, 60, QMC::EnumFlags{}).add({
...
template <> constexpr inline auto QCPLegend::qt_create_metaobjectdata<qt_meta_tag_ZN9QCPLegendE_t>()
{
    ...
    QtMocHelpers::UintData qt_enums {
        // enum 'SelectablePart'
        QtMocHelpers::EnumData<enum SelectablePart>(23, 23, QMC::EnumFlags{}).add({
...
template <> constexpr inline auto QCPItemBracket::qt_create_metaobjectdata<qt_meta_tag_ZN14QCPItemBracketE_t>()
{
    ...
    QtMocHelpers::UintData qt_enums {
        // enum 'BracketStyle'
        QtMocHelpers::EnumData<enum BracketStyle>(5, 5, QMC::EnumFlags{}).add({
